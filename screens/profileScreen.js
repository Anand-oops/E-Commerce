...
const ProfileScreen = ({navigation}) => {
    ...
    ref.on('value', function (snapshot) {
		...
		const [value, setValue] = useState({
			...
			firstName: data.firstName, //Firebase.database().ref(`/Admin/${user.uid}/firstName`),
			lastName :data.lastName, //Firebase.database().ref(`/Admin/${user.uid}/lastName`),
			mobile:data.mobile, //Firebase.database().ref(`/Admin/${user.uid}/mobile`),
		})
		...
		return (
			...
			<View style={styles.container}>
				...
				<View style={styles.action}>
					...
					<TextInput
						placeholder={data.firstName} //{value.firstName.toString}
						blurOnSubmit={true}
				...
				<View style={styles.action}>
					<FontAwesome name="user-o" color={colors.text} size={20} />
					<TextInput
						placeholder={data.lastName} //{value.lastName.toString}
						placeholderTextColor="#666666"
						blurOnSubmit={true}
						autoCorrect={false}
						style={[
				...
				<TouchableOpacity style={styles.commandButton} onPress={() => { saveUser(); Keyboard.dismiss();}} >
